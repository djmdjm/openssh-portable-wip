...
rm -f rsa_1 ecdsa_1 ed25519_1 mldsa65_ed25519_1
rm -f rsa_2 ecdsa_2 ed25519_2 mldsa65_ed25519_2
rm -f rsa_n ecdsa_n # new-format keys
rm -f rsa_1_pw ecdsa_1_pw ed25519_1_pw mldsa65_ed25519_1_pw
...
ssh-keygen -t ssh-mldsa65-ed25519@openssh.com -C "MLDSA65-ED25519 test key #1" -N "" -f mldsa65_ed25519_1
...
ssh-keygen -t ssh-mldsa65-ed25519@openssh.com -C "MLDSA65-ED25519 test key #2" -N "" -f mldsa65_ed25519_2
...
cp mldsa65_ed25519_1 mldsa65_ed25519_1_pw
...
ssh-keygen -pf mldsa65_ed25519_1_pw -N "$PW"
...
ssh-keygen -s rsa_2 -I hugo -n user1,user2 \
    -Oforce-command=/bin/ls -Ono-port-forwarding -Osource-address=10.0.0.0/8 \
    -V 19990101:20110101 -z 4 mldsa65_ed25519_1.pub
ssh-keygen -s rsa_2 -I hugo -n user1,user2 \
    -Oforce-command=/bin/ls -Ono-port-forwarding -Osource-address=10.0.0.0/8 \
...
ssh-keygen -s ed25519_1 -I julius -n host1,host2 -h \
    -V 19990101:20110101 -z 8 mldsa65_ed25519_1.pub
ssh-keygen -s ecdsa_1 -I julius -n host1,host2 -h \
...
ssh-keygen -lf mldsa65_ed25519_1 | awk '{print $2}' > mldsa65_ed25519_1.fp
...
ssh-keygen -lf mldsa65_ed25519_2 | awk '{print $2}' > mldsa65_ed25519_2.fp
...
ssh-keygen -lf mldsa65_ed25519_1-cert.pub  | awk '{print $2}' > mldsa65_ed25519_1-cert.fp
...
ssh-keygen -Bf mldsa65_ed25519_1 | awk '{print $2}' > mldsa65_ed25519_1.fp.bb
...
ssh-keygen -Bf mldsa65_ed25519_2 | awk '{print $2}' > mldsa65_ed25519_2.fp.bb
