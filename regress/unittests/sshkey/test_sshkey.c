...
sshkey_tests(void)
{
	...
	TEST_START("new/free KEY_MLDSA65_ED25519");
	k1 = sshkey_new(KEY_MLDSA65_ED25519);
	ASSERT_PTR_NE(k1, NULL);
	...
	TEST_START("generate KEY_MLDSA65_ED25519");
	ASSERT_INT_EQ(sshkey_generate(KEY_MLDSA65_ED25519, 256, &k1), 0);
	ASSERT_PTR_NE(k1, NULL);
	ASSERT_INT_EQ(k1->type, KEY_MLDSA65_ED25519);
	...
	k1 = NULL;
	ASSERT_INT_EQ(sshkey_generate(KEY_MLDSA65_ED25519, 256, &k1), 0);
	ASSERT_INT_EQ(sshkey_generate(KEY_MLDSA65_ED25519, 256, &k2), 0);
	...
	TEST_START("demote KEY_MLDSA65_ED25519");
	ASSERT_INT_EQ(sshkey_generate(KEY_MLDSA65_ED25519, 256, &k2), 0);
	...
	TEST_START("equal KEY_MLDSA65_ED25519/demoted KEY_MLDSA65_ED25519");
	...
	TEST_START("certify key MLDSA65-ED25519");
	ASSERT_INT_EQ(sshkey_load_public(
	    test_data_file("mldsa65_ed25519_1.pub"), &k1, NULL), 0);
	k2 = get_private("mldsa65_ed25519_2");
	ASSERT_INT_EQ(sshkey_to_certified(k1), 0);
	ASSERT_PTR_NE(k1->cert, NULL);
	k1->cert->type = SSH2_CERT_TYPE_USER;
	k1->cert->serial = 1234;
	...
	TEST_START("sign and verify MLDSA65-ED25519");
	k1 = get_private("mldsa65_ed25519_1");
	ASSERT_INT_EQ(sshkey_load_public(
	    test_data_file("mldsa65_ed25519_2.pub"), &k2, NULL), 0);
	signature_tests(k1, k2, NULL);
	sshkey_free(k1);
	sshkey_free(k2);
	k1 = k2 = NULL;
...
sshkey_benchmarks(void)
{
	...
	BENCH_START("generate MLDSA65-ED25519");
	TEST_START("generate KEY_MLDSA65_ED25519");
	ASSERT_INT_EQ(sshkey_generate(KEY_MLDSA65_ED25519, 256, &k), 0);
	ASSERT_PTR_NE(k, NULL);
	sshkey_free(k);
	k = NULL;
	TEST_DONE();
	...
	signature_benchmark("MLDSA65-ED25519", KEY_MLDSA65_ED25519, 0, NULL, 0);
	...
	signature_benchmark("MLDSA65-ED25519", KEY_MLDSA65_ED25519, 0, NULL, 1);
}
